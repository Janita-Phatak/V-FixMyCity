<template>
  ...
  <div id="blog" class="bg-gray-50 px-4 pt-28 pb-5">
              ...
              <div class="w-full">
                ...
                <div class="mt-4 flex items-center">
                  <button class="
                    ...
                    <span v-if="item.likedBy.length > 0" class="text-gray-700 text-base">{{ item.likedBy.length
                    }}</span>
                  </button>
                  <button class="
                      flex
                    ...
                    <span v-if="item.commentIDs.length > 0" class="text-gray-700 text-base">{{ item.commentIDs.length
                    }}</span>
                  </button>
                </div>
              </div>
